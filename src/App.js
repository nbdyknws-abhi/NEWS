    ...
    return (
      <div>
        <Router>
          ...
          {/* <News pageSize={this.pageSize} country="us" category="general"/> category for category wise news fetching , do in category=${this.props.category&apikey= in news.js also and pass all category upon navbar in newsitem} */}
          {/* this.props.pageSize in news.js to variable pagesize in newsmonkey */}
          <Routes>
